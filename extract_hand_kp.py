...
# Paths
videos_dir = r"c:\sign language name\videos for that sign language"
output_keypoints_dir = r"output directory for keypoints"

labels_csv_path = r"directory for the labels (csv file) of the sign language"
